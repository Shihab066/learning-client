...
const ClassCard = ({ item, overlay, btn, cardForClass, selectClass, propularClass }) => {
    ...
    return (
        <div className='flex justify-center'>
            <div className={`card relative w-[90%] xl:w-96 ${cardForClass && !overlay && 'h-[526px]'} shadow-xl ${overlay && 'image-full'} ${seats == 0 && cardForClass && 'opacity-60'}`}>
                ...
                <div className="card-body xs:p-4 sm:p-6 lg:p-8 ">
                    ...
                    {email && !cardForClass && <span className="text-gray-500 xs:text-[13px] lg:text-sm truncate">E-mail: {email}</span>}
                    {btn &&
