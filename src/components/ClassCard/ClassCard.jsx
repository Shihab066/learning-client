...
const ClassCard = ({ item, overlay, btn, cardForClass, selectClass, propularClass }) => {
    ...
    return (
        <div className='flex justify-center'>
            <div className={`card relative xs:w-[180px] sm:w-[300px] md:w-[250px] lg:w-[320px] xl:w-96 ${cardForClass && !overlay && 'h-[526px]'} shadow-xl ${overlay && 'image-full'} ${seats == 0 && cardForClass && 'opacity-60'}`}>
