            ...
            <div className='mt-20 sm:mt-36 lg:mt-40 grid md:grid-cols-2 gap-y-6 md:gap-y-0'>
                ...
                <div className='justify-self-center order-1 md:order-2'>
                    <div className='lg:w-[500px] text-left px-3 sm:pr-4 md:pr-4 xl:pr-0'>
                        ...
                        <div>
                            <h4 className='flex justify-start items-center font-semibold md:text-base lg:text-lg gap-2 mb-3'><RiShieldCheckLine className='text-xl'></RiShieldCheckLine> Internship Programs</h4>
                        ...
                        <div>
                            <h4 className='flex justify-start items-center font-semibold md:text-base lg:text-lg gap-2 my-3'><RiShieldCheckLine className='text-xl'></RiShieldCheckLine> Job Search Strategies</h4>
                            <p className='text-sm lg:text-base'>
                        ...
                        <div>
                            <h4 className='flex justify-start items-center font-semibold md:text-base lg:text-lg gap-2 my-3'><RiShieldCheckLine className='text-xl'></RiShieldCheckLine> Mock Interviews</h4>
                            <p className='text-sm lg:text-base'>
