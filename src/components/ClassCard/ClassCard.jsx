...
const ClassCard = ({ item, overlay, btn, cardForClass,selectClass }) => {
    ...
    return (
        <div className='flex justify-center'>
            <div className={`card relative w-11/12 md:w-96  shadow-xl ${overlay && 'image-full'} ${seats == 0 && cardForClass && 'opacity-60'}`}>
                <figure className='h-[255px] bg-base-200'><img src={image || noImg} className="hover:scale-105 ease-linear duration-300" alt={cardForClass ? 'classImg' : 'instructor-Img'} /></figure>
                ...
                <div className="card-body">
                    ...
                    {showSeats && <span className={`${seats == 0 && 'text-red-500'}`}>Available Seats: {seats}</span>}
