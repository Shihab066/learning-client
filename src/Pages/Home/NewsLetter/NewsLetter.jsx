                ...
                <div className="w-full md:w-[65%] lg:w-[60%] h-full text-center sm:text-left change-shape bg-black text-white flex justify-center sm:justify-end items-center sm:pr-2 md:pr-0">
                    <div className="sm:w-[75%] p-5 sm:p-0">
                        ...
                        <div className="flex justify-center sm:justify-start items-center gap-2 mt-4">
                            <input type="text" placeholder="Enter your e-mail" className='text-gray-900 font-normal text-sm md:text-base focus:outline-none box-border w-full sm:w-[60%] md:w-[200px] lg:w-[250px] xl:w-[280px] py-2 lg:py-3 px-3 rounded overflow-hidden' />
                            <button className="px-2 lg:px-3 h-[38px] min-h-[38px] md:h-[42px] md:min-h-[42px] lg:h-[48px] lg:min-h-[48px] btn lg:btn-md bg-blue-600 text-white text-xs md:text-sm capitalize border-none rounded">
                                Subscribe
                            </button>
                        </div>
                    </div>
