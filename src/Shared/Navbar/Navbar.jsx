            ...
            <nav className=" bg-base-200 sticky top-0 z-50">
                <div className="navbar lg-container">
                    <div className="navbar-start z-20">
                        ...
                        <a className="btn btn-ghost hover:bg-transparent  normal-case text-2xl">𝙎𝙥𝙤𝙧𝙩𝙀𝙓</a>
                        ...
                        <div>
                            {loading ? <span className="loading loading-ring loading-lg"></span> :
                                user ? <div className="flex items-center gap-2 mr-2 md:mr-0">
                                    {user.photoURL && <img src={user.photoURL} className="w-10 h-10 rounded-full" referrerPolicy="no-referrer" title={user.displayName ? user.displayName : ''} alt="" />}
