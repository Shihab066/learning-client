            ...
            <footer className="lg-container footer pt-12 pb-10 pl-6 sm:p-10 text-white text-opacity-70 font-medium sm:grid-cols-2 md:flex md:justify-between md:flex-wrap">
                ...
                <div>
                    ...
                    <div className="flex gap-x-2 mt-2">
                        {/* Facebook */}
                        <a href="#">
                            <div className="bg-[#1877f2] p-[10px] rounded hover:opacity-80 transition-opacity">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="white" width="16" height="16" aria-hidden="true">
                        ...
                        <a href="#">
                            <div className="bg-white p-[10px] rounded hover:opacity-80 transition-opacity">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="black" width="16" height="16" viewBox="0 0 512 512" aria-hidden="true">
                        ...
                        {/* YouTube */}
                        <a href="#">
                            <div className="bg-[#bb0000] p-[10px] rounded hover:opacity-80 transition-opacity">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 360" fill="white" width="16" height="16" aria-hidden="true">
                        ...
                        {/* LinkedIn */}
                        <a href="#">
                            <div className="bg-[#0a66c2] p-[10px] rounded hover:opacity-80 transition-opacity">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="white" width="16" height="16" aria-hidden="true">
